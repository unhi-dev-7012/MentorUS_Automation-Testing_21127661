...
switch (icon) {
	case '1':
		WebUI.click(findTestObject('Object Repository/Popup_Add New Group Type/li_1'))
		break
	case '2':
		WebUI.click(findTestObject('Object Repository/Popup_Add New Group Type/li_2'))
		break
	case '3':
		WebUI.click(findTestObject('Object Repository/Popup_Add New Group Type/li_3'))
		break
	case '4':
		WebUI.click(findTestObject('Object Repository/Popup_Add New Group Type/li_4'))
		break
	case '5':
		WebUI.click(findTestObject('Object Repository/Popup_Add New Group Type/li_5'))
		break
	case '6':
		WebUI.click(findTestObject('Object Repository/Popup_Add New Group Type/li_6'))
		break
	case '7':
		WebUI.click(findTestObject('Object Repository/Popup_Add New Group Type/li_7'))
		break
	case '8':
		WebUI.click(findTestObject('Object Repository/Popup_Add New Group Type/li_8'))
		break
	default:
		break
}
...
if (isSuccess == 'true') {
    ...
    WebUI.verifyElementText(findTestObject('Object Repository/Popup_Add New Group Type/verify_text_typeName'), typeName, 
        FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.verifyElementText(findTestObject('Object Repository/Popup_Add New Group Type/verify_text_description'), description, 
        FailureHandling.CONTINUE_ON_FAILURE)
} else {
    String regex = ('.*' + expected) + '.*'
    ...
    String actualText = WebUI.getText(findTestObject('Object Repository/Popup_Add New Group Type/h2_error_add_new_type'), 
        FailureHandling.CONTINUE_ON_FAILURE)
    ...
    WebUI.verifyElementText(findTestObject('Object Repository/Popup_Add New Group Type/verify_text_typeName'), prevType, 
        FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.verifyElementText(findTestObject('Object Repository/Popup_Add New Group Type/verify_text_description'), prevDescription, 
        FailureHandling.CONTINUE_ON_FAILURE)
}
