...
if (description.length() > 200)
{
	...
	if (isSuccess == 'true') {
		...
		String actualText = WebUI.getText(findTestObject('Object Repository/Popup_Add New Group Type/h2_successMessage'), FailureHandling.OPTIONAL)
		...
		String actualText = WebUI.getText(findTestObject('Object Repository/Popup_Add New Group Type/h2_error_add_new_type'), FailureHandling.OPTIONAL)
